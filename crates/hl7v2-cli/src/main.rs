...
use corpus::{corpus_diff_command, corpus_fingerprint_command, corpus_summarize_command};
use stats::stats_command;

#[cfg(test)]
pub(crate) use corpus::{format_corpus_diff, format_corpus_fingerprint, format_corpus_summary};
#[cfg(test)]
pub(crate) use stats::{SegmentStats, StatsReport, collect_stats, format_stats_report};
mod config;
mod corpus;
mod monitor;
mod stats;
