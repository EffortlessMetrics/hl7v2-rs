//! Benchmarks for HL7 v2 escape sequence handling performance with clean text

use criterion::{black_box, criterion_group, criterion_main, Criterion};
use hl7v2_core::{unescape_text, escape_text, Delims};

/// Create sample clean text (no delimiters) for benchmarking
fn create_clean_text() -> String {
    "This is a normal text string with no special characters 1234567890".to_string()
}

/// Benchmark unescaping clean text (should be faster with optimization)
...
/// Benchmark escaping clean text (should be faster with optimization)
