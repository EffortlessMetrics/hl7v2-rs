...
pub fn unescape_text(text: &str, delims: &Delims) -> Result<String, Error> {
    // Optimization: if no escape character is present, just return the text
    // This avoids allocation and iteration for the common case
...
pub fn escape_text(text: &str, delims: &Delims) -> String {
    // Optimization: if no delimiters are present, just return the text
    // This avoids allocation of a new string and character iteration
