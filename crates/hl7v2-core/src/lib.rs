...
pub fn unescape_text(text: &str, delims: &Delims) -> Result<String, Error> {
    // Optimization: If no escape character is present, return original text
    // This avoids allocation and character processing for the common case
...
pub fn escape_text(text: &str, delims: &Delims) -> String {
    // Optimization: Check if any escaping is needed first
    // This avoids unnecessary allocation for the common case
