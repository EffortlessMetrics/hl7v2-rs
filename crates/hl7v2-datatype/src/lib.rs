...
mod tests {
    ...
    #[test]
    fn test_validate_datatype_date() {
        assert!(validate_datatype("20250128", "DT"));
    ...
    #[test]
    fn test_validate_datatype_time() {
    ...
    #[test]
    fn test_validate_datatype_timestamp() {
    ...
    #[test]
    fn test_validate_datatype_numeric() {
    ...
    #[test]
    fn test_validate_datatype_person_name() {
        assert!(validate_datatype("Smith^John", "PN"));
        assert!(validate_datatype("O'Brien^Mary", "PN"));
        assert!(!validate_datatype("Smith123", "PN"));
    }
    ...
    fn test_validator_builder() {
        ...
        assert!(!validator.validate("a")); // Too short
        assert!(!validator.validate("this is way too long")); // Too long
    }
    ...
    fn test_validator_pattern() {
        ...
        assert!(!validator.validate("123456789"));
    }

    #[test]
    fn test_validator_allowed_values() {
        let validator = DataTypeValidator::new()
            .with_allowed_values(vec!["M".to_string(), "F".to_string(), "U".to_string()]);
    ...
    fn test_luhn_checksum() {
        assert!(validate_luhn_checksum("4532015112830366")); // Valid test card number
    ...
    fn test_ssn_validation() {
        ...
        assert!(!is_ssn("000-45-6789")); // Invalid area
        assert!(!is_ssn("123-00-6789")); // Invalid group
        assert!(!is_ssn("123-45-0000")); // Invalid serial
    }
