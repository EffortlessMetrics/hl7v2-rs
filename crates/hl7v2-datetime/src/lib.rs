...
mod tests {
    ...
    #[test]
    fn test_parse_hl7_date_invalid() {
        assert!(parse_hl7_dt("20251301").is_err()); // Invalid month
        assert!(parse_hl7_dt("20250132").is_err()); // Invalid day
        assert!(parse_hl7_dt("2025").is_err());     // Too short
        assert!(parse_hl7_dt("2025012a").is_err()); // Non-digit
    }

    #[test]
    fn test_parse_hl7_time() {
    ...
    #[test]
    fn test_parse_hl7_timestamp_date_only() {
    ...
    #[test]
    fn test_is_valid_functions() {
        assert!(is_valid_hl7_date("20250128"));
        assert!(!is_valid_hl7_date("20251328"));
        
        assert!(is_valid_hl7_time("152312"));
        assert!(is_valid_hl7_time("1523"));
        assert!(!is_valid_hl7_time("2523"));
        
        assert!(is_valid_hl7_timestamp("20250128152312"));
        assert!(is_valid_hl7_timestamp("20250128"));
        assert!(!is_valid_hl7_timestamp("2025"));
    }
}