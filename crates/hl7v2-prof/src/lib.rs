...
#![allow(clippy::manual_range_contains, clippy::collapsible_if, clippy::needless_question_mark, clippy::needless_borrow, clippy::manual_strip, clippy::wildcard_in_or_patterns, clippy::manual_contains, clippy::module_inception, unused_imports)]
