...
pub struct ServerConfig {
    ...
    /// Optional API key for authentication (overrides environment variable)
    pub api_key: Option<String>,
}
...
impl Server {
    ...
    pub fn new(config: ServerConfig) -> Self {
        ...
        // Load expected API key from config or environment
...
mod tests {
    ...
    fn test_server_builder() {
        ...
        assert_eq!(server.config.api_key.as_deref(), Some("test-key"));
    }
