//! Profile fixture test runner and expected-report comparison helpers.

use super::{
    ExpectedReportComparison, Profile, ProfileFixtureExpectation, ProfileTestCaseReport,
    ProfileTestReport, types::ExpectedReportCandidate,
};
...
fn run_profile_fixture_case(
    ...
    let issues = super::validate(&message, profile);
    let validation_report = super::super::validation::ValidationReport::from_issues(
        &message,
...
fn compare_expected_report_candidate(
    ...
    actual_report: &super::super::validation::ValidationReport,
