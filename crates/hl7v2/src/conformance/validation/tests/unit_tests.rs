...
#[test]
fn test_validate_data_type_ad_and_xtn() {
    assert!(validate_data_type("123 Main St", "AD"));
    assert!(!validate_data_type("ctrl\x01char", "AD"));
    assert!(validate_data_type("5551234", "XTN"));
    assert!(!validate_data_type("123", "XTN"));
}
