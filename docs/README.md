...
| [Cross-surface evidence parity gap audit](audits/cross-surface-evidence-parity-gap-audit-2026-05-18.md) | Current implementation gap map after guide smokes, dirty-corpus parity, Python registry proof-command routing, and the blocked public-registry proof boundary. |
