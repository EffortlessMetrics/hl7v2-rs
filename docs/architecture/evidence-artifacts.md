...
| --- | --- | --- | --- |
| Doctor report | `hl7v2 doctor --format json|yaml|text` | CLI-local `DoctorReport` | Has tool `version`; JSON Schema exists at `schemas/evidence/doctor-report-v1.schema.json`. The report has no embedded `schema_version`; v1 is the current compatible shape. |
