...
| Python | Exposes parse, JSON conversion, normalize, validation report dict/JSON parity, corpus summary/fingerprint/diff dict parity, and safe-analysis redaction dict output. It does not yet expose bundle or replay artifacts. |
