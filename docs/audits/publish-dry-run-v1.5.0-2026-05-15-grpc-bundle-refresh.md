# v1.5.0 Publish Dry-Run Refresh After gRPC Bundle Creation

Date: 2026-05-15
Commit: `47ba93201aaa15c95157d341bb5ec4f5f3871741`
Scope: non-publishing v1.5.0 readiness refresh after gRPC
`CreateEvidenceBundle` parity landed on `main`.
...
```powershell
$env:CARGO_TARGET_DIR = "F:\cargo-target\hl7v2-rs-readiness-grpc-bundle-refresh"
...
- No gRPC replay or quarantine parity claim.
