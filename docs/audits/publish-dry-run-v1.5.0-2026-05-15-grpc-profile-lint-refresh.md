# v1.5.0 gRPC Profile Lint Readiness Refresh - 2026-05-15

This receipt refreshes the v1.5.0 release-readiness proof after the RIPR
calibration audit and gRPC profile lint parity landed.
...
Refreshed commit:
`fe8680c551bc3ce9248063906cbbe90ffe732a70`.

Changes included since the prior numeric validation refresh:

- #635 recorded the advisory RIPR calibration audit after real PR traffic.
- #636 added gRPC `ProfileLint` parity with shared profile lint reports,
  opt-in v2 provenance, safe malformed-profile diagnostics, contract tests, and
  refreshed RIPR badge evidence.
...
- Target directory: `F:\cargo-target\hl7v2-rs-readiness-current-main`
- Cargo incremental: `0`
...
| `check-doc-links` | Passed. 162 Markdown files and 380 local links checked. |
| `check-file-policy` | Passed. 521 non-ignored files checked with 39 allowlist entries and 30 companion ledger entries. |
