# v1.5.0 Publish Dry-Run Refresh After gRPC Profile Test

Date: 2026-05-15
Commit: `915578b5cab5ab3abde7f806e5ad39c063d9cc82`
Scope: non-publishing v1.5.0 readiness refresh after gRPC `ProfileTest`
...
```powershell
$env:CARGO_TARGET_DIR = "F:\cargo-target\hl7v2-rs-readiness-grpc-profile-test-refresh"
...
- No gRPC bundle, replay, or quarantine parity claim.
