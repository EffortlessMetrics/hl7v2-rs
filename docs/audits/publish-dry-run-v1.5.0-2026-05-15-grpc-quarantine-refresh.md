# v1.5.0 Publish Dry-Run Refresh After gRPC Quarantine

Date: 2026-05-15
Commit: `a12c6fdf61396de74f971c27f4887dd7c451543b`
Scope: non-publishing v1.5.0 readiness refresh after gRPC
`ValidateRedacted` quarantine output parity landed on `main`.
...
```powershell
$env:CARGO_TARGET_DIR = "F:\cargo-target\hl7v2-rs-readiness-grpc-quarantine-refresh"
...
- gRPC quarantine output parity is now part of the current `ValidateRedacted`
  surface through #647.
