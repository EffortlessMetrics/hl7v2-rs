# v1.5.0 Publish Dry-Run Refresh After gRPC Replay

Date: 2026-05-15
Commit: `addbbe3e6962dc7f1629053c8a9c6810c7e37cc1`
Scope: non-publishing v1.5.0 readiness refresh after gRPC
`ReplayEvidenceBundle` parity landed on `main`.
...
```powershell
$env:CARGO_TARGET_DIR = "F:\cargo-target\hl7v2-rs-readiness-grpc-replay-refresh"
...
- No gRPC quarantine parity claim.
