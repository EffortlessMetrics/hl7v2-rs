# v1.5.0 Publish Dry-Run Refresh After Parity Documentation Sync

Date: 2026-05-15
Commit: `686dbff26afbbdcb97e4cc1915d1e33bd1404d14`
Scope: non-publishing v1.5.0 readiness refresh after the Python ACK local
binding claim and gRPC parity surface documentation were aligned with current
proof.
...
```powershell
$env:CARGO_TARGET_DIR = "F:\cargo-target\hl7v2-rs-readiness-parity-doc-refresh"
...
- The Python ACK parity sync was documentation-only; it used existing local
  wheel smoke proof and did not claim TestPyPI or PyPI availability.
- The gRPC parity surface sync was documentation-only; it aligned public
  wording with already implemented and tested RPCs.
...
- No new release graph decision; this receipt preserves the existing selected
  v1.5.0 graph.
