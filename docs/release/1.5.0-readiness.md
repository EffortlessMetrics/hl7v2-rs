...
| Current-main readiness refresh | Passed locally on `fe8680c551bc3ce9248063906cbbe90ffe732a70` after the profile evidence, Python profile helper, RIPR evidence-surface and calibration, gRPC profile lint and inline corpus summary/fingerprint/diff parity, cross-surface parity spec, first-use guide, dirty real-world corpus proof, gRPC serve-mode status sync, nightly property-command repair, and finite numeric validation updates. |
