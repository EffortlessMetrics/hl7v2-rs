...
| Current-main readiness refresh | Passed locally on `eb518e948d57bc07e96512ced306fe0db2dc2990` after the profile evidence, Python profile helper, RIPR evidence-surface, gRPC corpus-summary parity, cross-surface parity spec, first-use guide, dirty real-world corpus proof, and gRPC serve-mode status sync updates. |
...
- gRPC inline corpus summary, fingerprint, and diff parity;
