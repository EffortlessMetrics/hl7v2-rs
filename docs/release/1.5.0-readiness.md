...
| Current-main readiness refresh | Passed locally on `b0018c8760f07d738b3a6b7a11eeeda300786ef2` after the profile evidence, Python profile helper, RIPR evidence-surface, gRPC inline corpus summary/fingerprint/diff parity, cross-surface parity spec, first-use guide, dirty real-world corpus proof, gRPC serve-mode status sync, nightly property-command repair, and finite numeric validation updates. |
