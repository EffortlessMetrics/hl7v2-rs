...
| Python TestPyPI distribution (`hl7v2`) | Blocked | Hosted non-publishing wheel/import/evidence workflow proof passed on current `main`; see the [Python TestPyPI non-publish proof](../audits/python-testpypi-nonpublish-proof-2026-05-15.md). Issue [#563](https://github.com/EffortlessMetrics/hl7v2-rs/issues/563) remains the external Trusted Publisher blocker; TestPyPI success still requires upload and install-back receipt. |
