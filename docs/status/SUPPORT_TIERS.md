...
| First-use user journeys | Stable where released; Python registry blocked | Rust: `cargo test -p hl7v2 --test user_journey --all-features`; CLI: `cargo test -p hl7v2-cli --test integration_tests journey_cli_validate_redact_bundle_replay_produces_shareable_receipts`; server: `tests/server_smoke/smoke.py` against a running sidecar; public crates.io install-back: `python tests/public_crates_smoke/smoke.py --version 1.5.0`; Python local wheel: `cargo run -p xtask -- python-local-wheel-proof`. See the [user journey acceptance proof](../audits/user-journey-acceptance-2026-05-15.md) and [public crates install smoke](../audits/public-crates-install-first-use-2026-05-16.md). |
| Dirty corpus compatibility proof | Stable Rust core, CLI, REST, gRPC, and local Python wheel proof; CLI, REST, and gRPC also have dirty validate/redact/bundle/replay workflows; TypeScript not released | `test_data/dirty-real-world/`; `cargo run -p xtask -- check-dirty-corpus-parity`; `cargo run -p xtask -- check-dirty-corpus-parity --include-python` after local wheel install; [dirty real-world corpus proof](../audits/real-world-corpus-proof-2026-05-14.md); [shared fixture proof](../audits/dirty-real-world-corpus-shared-fixture-proof-2026-05-16.md); [server fixture proof](../audits/dirty-real-world-server-corpus-parity-2026-05-16.md); [Python fixture proof](../audits/dirty-real-world-python-corpus-parity-2026-05-16.md); [dirty-corpus parity readiness refresh](../audits/publish-dry-run-v1.5.0-2026-05-16-dirty-corpus-parity-refresh.md); [dirty-corpus evidence workflow readiness refresh](../audits/publish-dry-run-v1.5.0-2026-05-17-dirty-corpus-evidence-workflow-refresh.md) |
| Safe-error and PHI sentinel parity | Stable Rust core, CLI, REST, and gRPC proof; Python local-wheel proof command recorded; TypeScript not released | `test_data/security/safe-error-phi-parity.json`; `cargo run -p xtask -- check-safe-error-phi-parity`; `cargo run -p xtask -- check-safe-error-phi-parity --include-python` after local wheel install; [policy/evidence-parity.toml](../../policy/evidence-parity.toml) |
...
| Aggregate evidence parity acceptance | Stable Rust core, CLI, REST, and gRPC proof; Python local-wheel optional | `cargo run -p xtask -- check-evidence-parity-acceptance`; `cargo run -p xtask -- check-evidence-parity-acceptance --include-python` after local wheel install; public Python registry proof remains blocked by #563. |
...
[`adda4353aae604972670db82415bd5dac1a6373a`](../audits/publish-dry-run-v1.5.0-2026-05-17-dirty-corpus-evidence-workflow-refresh.md)
after the REST and gRPC dirty real-world validate-redacted/bundle/replay
workflow proof landed through #734. This is not a public Python `hl7v2`
TestPyPI/PyPI receipt.
